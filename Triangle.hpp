...
float rti(const Vector3f &v0, const Vector3f &v1, const Vector3f &v2,const Vector3f &orig, const Vector3f &dir,float &tnear, float &u, float &v)
{
    Vector3f edge1 = v1 - v0;
    Vector3f edge2 = v2 - v0;
    Vector3f pvec = crossProduct(dir, edge2);
...
public:
    ...
    Vector3f getBarycentric(Vector3f p);
...
inline Intersection Triangle::getIntersection(Ray ray){
    ...
    float u=1.0;
    float v=1.0;
    if(rayTriangleIntersect(v0,v1,v2,ray.origin,ray.direction,t_tmp,u,v)){
        t_tmp=rti(v0,v1,v2,ray.origin,ray.direction,t_tmp,u,v);
